<div class="w3-card-4 w3-display-middle " style="width:65%;max-height: 120%">
    ...
    <form class="w3-container" name="registrar" action="<?php echo $_SESSION["actionReg"] ?>.php?page=guardarUsuario" method="post" enctype="application/x-www-form-urlencoded">
        ...
        <div class="w3-row w3-center w3-margin-bottom">
            ...
            <div class="w3-half w3-container">
                <input class="w3-button w3-blue-grey w3-round" type="submit" name="boton" value="ENVIAR">
                <a href="interno.php?page=panelControl" style="text-decoration: none" class="w3-button w3-blue-grey w3-round w3-center w3-margin-left"  value="cancelar"> CANCELAR </a>
            </div>
            <div class="w3-container w3-quarter">
            </div>
        </div>
